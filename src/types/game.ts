// 20 Epochs of Ukrainian + World History
export type EpochId =
  ...
  | 'revolution'       // 781-850
  | 'soviet'           // 851-950
  | 'independence'     // 951-999
  // World History Epochs (13-20)
  | 'egypt'           // 1000-1050 (Rebirth 1)
  | 'greece'          // 1051-1100 (Rebirth 1)
  | 'rome'            // 1101-1150 (Rebirth 2)
  | 'medieval'        // 1151-1200 (Rebirth 2)
  | 'renaissance'     // 1201-1250 (Rebirth 3)
  | 'enlightenment'   // 1251-1300 (Rebirth 3)
  | 'victorian'       // 1301-1350 (Rebirth 4)
  | 'modern_world';   // 1351+ (Rebirth 5)
...
export interface Epoch {
  ...
  color: string;
  bgGradient: string;
  requiredRebirth: number; // Minimum rebirth level to unlock this epoch
}
...
export interface GameState {
  ...
  // SIT STUDIO EASTER EGG - Secret letter collection
  sitStudioLetters: Record<string, boolean>; // collected letters: 'S', 'I', 'T', 'space', 'S', 'T', 'U', 'D', 'I', 'O'
  sitStudioCompleted: boolean;
  // Referral system
